---
title: "Dashboard Operativo y Estadísticas del Túnel"
...
<Note>
  Las estadísticas por rango consultan el endpoint `GET /api/estadisticas/rango?desde=YYYY-MM-DD&hasta=YYYY-MM-DD`. Este endpoint es exclusivo para administradores. Un Guía que intente acceder a `/estadisticas` será redirigido automáticamente por el sistema de protección de rutas.
</Note>
