---
title: "Reportes PDF y Exportación de Datos del Sistema"
sidebarTitle: "Reportes"
description: "Conozca los cinco tipos de exportación PDF disponibles, dónde encontrar cada botón en la interfaz y cómo el servidor genera los documentos con Puppeteer."
---
...
| **Archivo descargado** | `Reporte_Visitas_MM_YYYY.pdf` |
| **Rol requerido** | Admin |

<Note>
  El reporte mensual, al igual que todas las exportaciones del Dashboard de Estadísticas, es exclusivo para el rol **Admin**. Un usuario con rol Guía no puede acceder a `/estadisticas` ni a estos endpoints.
</Note>
...
| **Archivo descargado** | `{Titulo_personalizado}.pdf` o `Informe_DD/MM/AAAA_-_DD/MM/AAAA.pdf` |
| **Rol requerido** | Admin |
...
| `titulo` | ❌ | Título personalizado del informe. Si se omite, se genera automáticamente como `Informe DD/MM/AAAA - DD/MM/AAAA`. |
